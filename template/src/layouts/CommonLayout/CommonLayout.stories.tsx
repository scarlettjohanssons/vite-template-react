...
import CommonLayout, { CommonLayoutProps } from '@layouts/CommonLayout/index';
...
export const Default: React.FC<CommonLayoutProps> = (args) => (
  <Route element={<CommonLayout {...args} />}>
    <Route
      path={'/'}
      element={
        <>
